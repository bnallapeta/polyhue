...
make build  # Output: target/wasm32-wasip2/release/color_rs.wasm
```

## Compose

```bash
wasmcp compose server target/wasm32-wasip2/release/color_rs.wasm -o server.wasm
```
...
# Stdio
wasmcp compose server target/wasm32-wasip2/release/color_rs.wasm -t stdio -o server.wasm
