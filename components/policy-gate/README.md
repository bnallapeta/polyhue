...
make build  # Output: target/wasm32-wasip2/release/policy_gate.wasm
```

## Compose

```bash
wasmcp compose server target/wasm32-wasip2/release/policy_gate.wasm -o server.wasm
```
...
# Stdio
wasmcp compose server target/wasm32-wasip2/release/policy_gate.wasm -t stdio -o server.wasm
